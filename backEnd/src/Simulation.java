    ...
    public static void createFile() {
        ...
        try {
            ...
            if (actFile.createNewFile()) {
                System.out.println("You file has been created.");
            } else {
