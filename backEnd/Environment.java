...
public class Environment {
    ...
    public Environment(int nutrients, int totBMonomers, int FBMonomers, int EPSMonomers, int bacteria, int yBlocks,
            int xBlocks) {
    ...
    public void createMonomers(int monomers, String type) {
        ...
        for (int i = 0; i < monomers; i++) {
            ...
            if (type.equals("bacterial")) {
                ...
                BacterialMonomer BMonomer = new BacterialMonomer(environBlocks[x][y], this.bMonomerID, "bacteria", 'r',
                        "covid");
    ...
    public void createNutrients(int nutrients) {
        ...
        for (int i = 0; i < nutrients; i++) {
            ...
            Nutrient nutrient = new Nutrient(environBlocks[x][y], nutrientID, type);
